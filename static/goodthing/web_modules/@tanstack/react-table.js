import '../common/compat.module-bc4b17ae.js';
import { h } from '../common/preact.module-f481626b.js';
import { useState as m } from '../preact/hooks.js';
...
function flexRender(Comp, props) {
  return !Comp ? null : isReactComponent(Comp) ? /*#__PURE__*/h(Comp, props) : Comp;
}
...
function useReactTable(options) {
  ...
  const [state, setState] = m(() => tableRef.current.initialState);
